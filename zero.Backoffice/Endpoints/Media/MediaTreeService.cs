...
//  public MediaTreeService(IMediaStore pages, IPageTypeService pageTypes, IRoutes routes)
//  {
//    Media = pages;
//    Routes = routes;
//    PageTypes = pageTypes;
...
//      {
//        zero_Pages_ByHierarchy.Result result = await Media.Session.Query<zero_Pages_ByHierarchy.Result, zero_Pages_ByHierarchy>()
...
//      children = await Media.Session.Query<zero_Pages_WithChildren.Result, zero_Pages_WithChildren>()
