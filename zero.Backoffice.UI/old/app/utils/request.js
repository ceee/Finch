...
function collection(base) {
    var _this = this;
    return {
        getById: function (id, changeVector, config) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, get(base + 'getById', __assign(__assign({}, config), { params: { id: id, changeVector: changeVector } }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        }); }); },
        ...
        getRevisions: function (id, query, config) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, get(base + 'getRevisions', __assign(__assign({}, config), { params: { id: id, query: query } }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        }); }); },
