...
[ApiController]
[Route("/api/captcha")]
public class CaptchaController(ICaptchaService captchaService) : MixtapeController
{
  [HttpPost("challenge")]
  ...
  {
    Assembly assembly = typeof(MixtapeSecurityModule).GetTypeInfo().Assembly;
    Stream resource = assembly.GetManifestResourceStream("mixtape/res/cap/cap.wasm");
  ...
  {
    Assembly assembly = typeof(MixtapeSecurityModule).GetTypeInfo().Assembly;
    Stream resource = assembly.GetManifestResourceStream("mixtape/res/cap/cap.js");
