...
public class StaticMediaCreator : MediaCreator, IStaticMediaCreator
{
  ...
  public StaticMediaCreator(IMediaFileSystem fileSystem, IMixtapeOptions options, IWebHostEnvironment hostingEnvironment, MediaMetadataCache cacheProvider, ILogger<IMediaCreator> logger) : base(fileSystem, options, logger)
  {
