...
public static class MediaExtensions
{
  ...
  public static string Resize(this string path, string preset, bool isMixtapeMedia) => path.Resize(preset, null, isMixtapeMedia);

  public static string Resize(this string path, string preset, MediaFocalPoint focalPoint = null, bool isMixtapeMedia = false)
  {
