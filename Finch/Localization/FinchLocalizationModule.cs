...
internal class FinchLocalizationModule : FinchModule
{
  public override void ConfigureServices(IServiceCollection services, IConfiguration configuration)
  {
    ...
    services.AddOptions<LocalizationOptions>().Bind(configuration.GetSection("Finch:Localization")).Configure(opts =>
    {
