...
public static class MediaExtensions
{
  ...
  public static string Resize(this string path, string preset, bool isFinchMedia) => path.Resize(preset, null, isFinchMedia);

  public static string Resize(this string path, string preset, MediaFocalPoint focalPoint = null, bool isFinchMedia = false)
  {
