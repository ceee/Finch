...
public class StaticMediaCreator : MediaCreator, IStaticMediaCreator
{
  ...
  public StaticMediaCreator(IMediaFileSystem fileSystem, IFinchOptions options, IWebHostEnvironment hostingEnvironment, MediaMetadataCache cacheProvider, ILogger<IMediaCreator> logger) : base(fileSystem, options, logger)
  {
