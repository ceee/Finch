...
namespace zero.Core.Api
{
  public abstract class ApiBase
  {
    ...
    /// </summary>
    protected async Task<EntityResult<T>> Save<T>(T model, IValidator<T> validator = null) where T : IDatabaseEntity
    {
      // check for alias
      ...
      if (model.Id.IsNullOrEmpty())
      {
        ...
        model.AppId = Constants.Database.SharedAppId; // TODO correct app id
      }
